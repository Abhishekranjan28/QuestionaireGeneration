...
if not st.session_state.logged_in:
    ...
    language= st.selectbox("Select the language",["English","Hindi","Telugu","Arabic","Italian","Portuguese","Tamil","Kannada","Malyalam","Greek"])
    ...
    if st.button("Generate Deep Questioning Questions"):
        ...
        f"**Instructions:**\n"
        f"***Add Logic and reasoning and thought process behind Questions to give it humanly touch.***\n\n"
